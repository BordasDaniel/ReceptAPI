...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Recept>(entity =>
        {
            ...
            entity.HasIndex(e => new { e.NehezsegId, e.SzakacsId }, "nehezsegId");
        ...
        modelBuilder.Entity<Recepthozzavalo>(entity =>
        {
            entity
                .HasNoKey()
                .ToTable("recepthozzavalo");

            entity.HasIndex(e => e.HozzavaloId, "hozzavaloId");

            entity.HasIndex(e => new { e.Receptid, e.HozzavaloId }, "receptid");
            ...
            entity.HasOne(d => d.Hozzavalo).WithMany()
                .HasForeignKey(d => d.HozzavaloId)
                .HasConstraintName("recepthozzavalo_ibfk_1");

            entity.HasOne(d => d.Recept).WithMany()
